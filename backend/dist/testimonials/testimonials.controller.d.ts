...
export declare class TestimonialsController {
    ...
    findAllAdmin(): Promise<import("./entities/testimonial.entity").Testimonial[]>;
    ...
    remove(id: string): Promise<import("./entities/testimonial.entity").Testimonial>;
    approve(id: string): Promise<import("./entities/testimonial.entity").Testimonial>;
}
